...
Requires:       ros-rolling-builtin-interfaces-devel
Requires:       ros-rolling-service-msgs-devel
Requires:       ros-rolling-unique-identifier-msgs-devel
...
%package runtime
Summary:        Runtime-only files for action_msgs package
Requires:       ros-rolling-builtin-interfaces-runtime
Requires:       ros-rolling-rosidl-core-runtime-runtime
Requires:       ros-rolling-service-msgs-runtime
Requires:       ros-rolling-unique-identifier-msgs-runtime
...
BuildRequires:  ros-rolling-service-msgs-devel
BuildRequires:  ros-rolling-unique-identifier-msgs-devel
...
%description runtime
Runtime-only files for action_msgs package
...
for f in \
    ...
    /opt/ros/rolling/share/action_msgs/cmake/ \
    /opt/ros/rolling/share/action_msgs/package.dsv \
    /opt/ros/rolling/share/action_msgs/package.xml \
; do
...
%exclude /opt/ros/rolling/share/action_msgs/cmake
%exclude /opt/ros/rolling/share/action_msgs/package.dsv
%exclude /opt/ros/rolling/share/action_msgs/package.xml
