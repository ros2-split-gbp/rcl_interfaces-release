...
Requires:       ros-rolling-rcl-interfaces-devel
...
%package runtime
Summary:        Runtime-only files for composition_interfaces package
Requires:       ros-rolling-rcl-interfaces-runtime
...
BuildRequires:  ros-rolling-rcl-interfaces-devel
...
%description runtime
Runtime-only files for composition_interfaces package
...
for f in \
    ...
    /opt/ros/rolling/share/composition_interfaces/cmake/ \
    /opt/ros/rolling/share/composition_interfaces/package.dsv \
    /opt/ros/rolling/share/composition_interfaces/package.xml \
; do
...
%exclude /opt/ros/rolling/share/composition_interfaces/cmake
%exclude /opt/ros/rolling/share/composition_interfaces/package.dsv
%exclude /opt/ros/rolling/share/composition_interfaces/package.xml
